...
to setup
 clear-all 
  ...
  draw-world
  create-lego-robots 1 [set color blue set size 4 setxy -13 -17 set heading 0 update-sensors]
  reset-ticks
end
...
to turnaway-after-bump
  update-sensors
  ifelse bump
    [rotate random 360]  ;when the robot bumps into a wall it turns away in a randomly chosen new direction
    [go-forward]
end
